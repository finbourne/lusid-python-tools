...
from lusid.models import PortfolioHolding, ModelProperty, PropertyValue, CurrencyAndAmount
...
class CocoonExtractGroupHoldingsTests(unittest.TestCase):
    ...
    def test_join_holdings(self, _, holdings_to_join, group_by_portfolio, dict_key, expected_outcome):
