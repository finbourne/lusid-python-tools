...
class TestResponseToPandasObject(unittest.TestCase):
    ...
    def test_transaction_alias_response_to_df(self):
        ...
        transaction_alias_df_format = lusid_response_to_data_frame(transaction_alias_response, rename_properties=True)
        ...
        self.assertEqual(transaction_alias_df_format.loc["transaction_class"][0], "Basic")
