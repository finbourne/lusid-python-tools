...
class CocoonUtilitiesTests(unittest.TestCase):
    ...
    @parameterized.expand(
        [
            ...
            (
                "use_global_type_flag_if_no_file_type_flag",
                None,
                {
                    "cash_identifiers": {
                        "instrument_name": ["inst1", "inst2", "inst3", "inst4"],
            ...
            (
                "use_file_type_flag_over_global_flag",
                {
                    "cash_identifiers": {
                        "instrument_name": {
                            "inst1": "GBP_EXP",
    ...
    def test_cash_flag_file_type_global(self, _, cash_flag, global_cash_flag, expected_values):
        ...
        mappings = {
            file_type: {"identifier_mapping": identifier_mapping},
            "cash_flag": global_cash_flag,
        }
        if cash_flag:
            mappings[file_type] = {**mappings[file_type], **{"cash_flag": cash_flag}}
