...
def lusid_response_to_data_frame(lusid_response, rename_properties: bool = False):
    ...
    :param bool format_df: this parameter formats the returned DataFrame. Specifically, the formatter does two things;
    ...
    if rename_properties:
        ...
        for column in columns_to_rename:
            ...
            property_code = str(column[(column.rfind("/") + 1):])[:column[(column.rfind("/") + 1):].find(".")]
